...
export class Descriptor {
  ...
  makeRequest(method, params) {
     var newParams = JSON.parse(JSON.stringify(params));
       ...
       if(params.optionParams&&params.optionParams.pageNum&&params.optionParams.pageSize){ //添加是否有参数pageIndex  pageSize
         newParams.optionParams.pageNum = (newParams.optionParams.pageNum-1)*newParams.optionParams.pageSize;
       }
